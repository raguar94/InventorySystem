...
#include "Engine/ISInventoryMappingDataAsset.h"
#include "Types/ISInventoryTypes.h"

#include "ISInventoryGISSubsystems.generated.h"
...
class INVENTORYSYSTEM_API UISInventoryGISSubsystems : public UGameInstanceSubsystem
{
	GENERATED_BODY()

public:

	UISInventoryGISSubsystems();

	static UISInventoryGISSubsystems* Get(const UObject* worldContextObject);
...
protected:
	...
	TSoftObjectPtr<UISInventoryMappingDataAsset> ItemsDataAsset;
